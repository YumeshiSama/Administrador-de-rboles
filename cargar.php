...
//$sql = "INSERT INTO `arboles` (`id`, `id_usuario`, `id_edad`, `id_extraccion`, `id_magnitud`, `id_columnar`, `id_copa`, `id_salud`, `id_localidad`, `id_especie`, `latitud`, `longitud`, `fecha_carga`, `foto_tronco`, `foto_copa`, `distancia_prox`, `comentario`) VALUES (NULL, '$id_usuario', '$edad', '$extraccion', '$magnitud', '0', '$copa', '$salud', '0', '$especie', '$latitud', '$longitud', '$date', '$foto_tronco', '$foto_copa', '$distancia', '$comentario')";
